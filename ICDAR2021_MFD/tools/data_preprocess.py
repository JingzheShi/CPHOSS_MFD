...
if __name__ == '__main__':
    img_path = '/root/autodl-tmp/nature21/mfd_dataset/Ts11/img'  # Your split image path
    txt_path = '/root/autodl-tmp/nature21/mfd_dataset/Ts11/gt'   # Your split txt label path
    dst_path = '/root/autodl-tmp/nature21/mfd_dataset/Ts11/gt_icdar' # icdar txt label path
    train_path = '/root/autodl-tmp/nature21/mfd_dataset/Ts11'    # coco format json destination folder
